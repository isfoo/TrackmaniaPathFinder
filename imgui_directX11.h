...
namespace MyImGui {
    ...
    bool INIT(const std::u16string& windowName, WNDCLASSEXW& wc_out, HWND& hwnd_out) {
        ...
        hwnd_out = ::CreateWindowW(wc_out.lpszClassName, (LPCWSTR)windowName.c_str(), WS_SYSMENU | WS_CAPTION | WS_MINIMIZEBOX | WS_MAXIMIZEBOX	| WS_SIZEBOX /*WS_OVERLAPPEDWINDOW*/, 100, 100, 1200, 800, NULL, NULL, wc_out.hInstance, NULL);
